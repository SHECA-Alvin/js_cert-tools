...
export default class ecPKCS {
  static toPKCS8(key: string, msg?: any): string|null {
    // convert
    ...
    const curveOID = asn1js.result.valueBlock.value[2].valueBlock.value[0];
    const privateKeyOctetString = asn1js.result.valueBlock.value[1];
    const privateKeyBitString = asn1js.result.valueBlock.value[3].valueBlock.value[0];
